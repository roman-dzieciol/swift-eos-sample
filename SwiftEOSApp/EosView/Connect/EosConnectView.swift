...
struct EosConnectView: View {
    ...
    var body: some View {
        List {
            ...
            NavigationLink("Delete Device Id", destination: EosResultCodeView("Delete Device Id") { completion in
                try eos.connect.DeleteDeviceId() { completion($0) }
            } views: {
                KeyValueText("Result:", $0.ResultCode.description)
            })

            NavigationLink("Get Logged In Users", destination: EosCompletionView("Get Logged In Users") {
