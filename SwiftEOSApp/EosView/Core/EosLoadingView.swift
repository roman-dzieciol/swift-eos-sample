...
struct EosCompletionResultCodeView<CallbackInfo, BuilderView>: View where CallbackInfo: CallbackInfoWithResult, BuilderView: View {
...
struct EosResultView<Info, BuilderView>: View where BuilderView: View {
