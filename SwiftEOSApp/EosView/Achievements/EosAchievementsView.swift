...
struct EosAchievementsView: View {
    ...
    var body: some View {
        ...
        List {
            NavigationLink("Query Definitions", destination: EosResultCodeView("Query Definitions") {
            ...
            NavigationLink("Get Definitions", destination: EosCompletionView("Get Definitions") {
